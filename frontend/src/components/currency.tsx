      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="w-full max-w-[85rem] py-12 px-5 bg-[#f8f8f8] mx-auto">
          <div className="block mb-4 mx-auto border-b border-slate-300 pb-2">
            ...
            >
              Need a website that doesn't stress your customers with cool
              features like this inbuilt currency converter feauture{" "}
              <a
                href="https://wa.me/+2349134730499?text=Hey%20NetoCodes%2C%20are%20you%20active%20for%20work%3F"
          ...
          <div className="w-full md:max-w-[65rem] bg-gray-100 shadow-lg mx-auto px-6 py-6 mt-4">
            <p className="text-slate-500 mb-4">
              Enter the amount you wish to convert and select the desired
              currency.
            </p>
            <div className="flex flex-col items-center justify-between">
              {/* From Currency Input */}
              <div className="w-full max-w-xs min-w-[200px] mt-4">
                <label className=" mb-1 flex items-center justify-between text-sm text-slate-800">
                  From{" "}
                  <span className="text-xs">our currency "turkish lira"</span>
                </label>
                        ...
                        {["TRY"].map((currency) => (
                          <ul>
                            <li
                              ...
                              onClick={() =>
                                handleCurrencyChange(setFromCurrency, currency)
                              }
                            >
                              {currency}
                            </li>
              ...
              {/* Swap Button */}
              <div
                onClick={() => handlecopy(convertedAmount)}
              ...
              >
                ...
                <RxClipboardCopy className="text-[#000] size-7 " />
                copy
              </div>
              ...
              <div className="w-full max-w-xs min-w-[200px] -mt-2">
                ...
                <div className="relative mt-2 flex flex-col gap-y-8 w-full ">
                  ...
                  <Menu>
                    <MenuHandler>
                      <Button
                        className="bg-[#8c2643] text-white font-semibold capitalize shadow-lg"
                    ...
                    >
                      {["NGN", "EUR", "TRY", "USD"].map((currency) => (
                        <MenuItem
                          key={currency}
                          onClick={() =>
                            handleCurrencyChange(setToCurrency, currency)
                          }
                          placeholder={undefined}
                          onPointerEnterCapture={undefined}
                          onPointerLeaveCapture={undefined}
            ...
            <div className="mt-8 text-slate-500 text-sm">
              <p>
                Rates are updated every hour to provide the most accurate
                conversions.
              </p>
              <p className="mt-1">
