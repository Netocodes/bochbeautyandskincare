...
const TestimonalPage = () => {
  const testimonials: testimonialData[] = [
   { id: 1,
     background: "https://i.pinimg.com/736x/4b/33/87/4b3387c5f0d799e121fa7c2f554e5ac1.jpg", image: "https://res.cloudinary.com/de7tyskql/image/upload/c_fill,g_auto,h_500,w_500/f_auto/q_auto/elegance-body-scrub-2?_a=DATAg1AAZAA0", 
     description: "Hey sis, I used the body scrub yesterday, and my skin feels incredibly soft—even softer than usual! It’s amazing! Where have you been all my life, especially here in Turkey? This scrub is a game-changer!"
    },

   { id: 2,
     background: "https://i.pinimg.com/736x/84/2c/4c/842c4c3938e9e7ad1b1dd70ee0d6145f.jpg", image: "https://res.cloudinary.com/de7tyskql/image/upload/c_fill,g_auto,h_500,w_500/f_auto/q_auto/facial-cleanser-and-cream?_a=DATAg1AAZAA0", 
     description: "Your products are truly one-of-a-kind—trust me! Of course, I’m coming back this month. I can’t get enough of how amazing they are!"
    },

   { id: 3, 
     background: "https://i.pinimg.com/736x/f1/5d/fb/f15dfb52bb930512c255b06e7d53d91b.jpg", image: "https://res.cloudinary.com/de7tyskql/image/upload/f_auto/q_auto/glam-glow-face?_a=DATAg1AAZAA0", 
                 ...
                 <div>
                   <blockquote className="relative  bg-black/45 backdrop-blur-lg  mx-auto py-8 px-6">
                     ...
                     <div className="relative z-10">
                       ...
                       <p className="text-xl font-medium px-4 italic text-gray-200 text-justify md:text-2xl dark:text-neutral-200">
