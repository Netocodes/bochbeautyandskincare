...
<div className="max-w-[85rem] bg-[#e6e4e4] px-4 py-10 sm:px-6 lg:px-12 lg:py-14 mx-auto">
  ...
  <div className="grid md:grid-cols-2 gap-12">
    <div className="lg:w-3/4">
      ...
      <p className="mt-5">
        <a className="inline-flex items-center gap-x-1 text-md underline underline-offset-4 text-[#831037] decoration-2 hover:underline focus:outline-none focus:underline font-medium " href="#">
    ...
    <div className="space-y-6 lg:space-y-10">
      ...
      <div className="flex gap-x-5 sm:gap-x-8">
        ...
        <div className="grow">
          <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-neutral-200">
            StartUp Skincare Collections for your skin needs
          </h3>
          <p className="mt-1 text-gray-600 dark:text-neutral-400">
