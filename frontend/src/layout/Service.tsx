    ...
    <div>
      <Helmet>
        <title className="text-[#82878a]">
          Beauty of Chiri Services | Expert Skincare Solutions & Care
        </title>
        ...
        <meta
          property="og:title"
          content="Beauty of Chiri Services | Expert Skincare Solutions & Care"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.bochbeautyandskincare.shop/services"
        />
      </Helmet>
